...
public abstract class Node implements Comparable<Node> {
	protected int depth; // Number of moves made so far (is equal to the number of nodes developed) on
							// this branch
	...
	protected int[] solution; // The solution generated for the node
	...
	/**
	 * Getter for the solution of this node
	 * 
	 * @return
	 */
	...
	/**
	 * We can have extra information about the problem to prune all the nodes above
	 * a specific heuristicValue. By default we know nothing, so we do not prune
	 * anything
	 * 
