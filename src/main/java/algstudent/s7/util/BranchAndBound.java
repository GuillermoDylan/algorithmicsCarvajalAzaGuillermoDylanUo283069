...
public abstract class BranchAndBound {
	...
	public int processedNodes = 0; // To count the number of nodes extracted from the priority queue to generate
										// their sons
	public int generatedNodes = 0; // To count the sons generated by the processed nodes independently if they are
										// trimmed afterwards

	public int notTrimmedNodes = 0; // To count the nodes inserted in the priority queue in order to then get the
										// non-trimmed ones
